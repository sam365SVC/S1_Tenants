...
func (_c *UserCreate) SetCi(v int) *UserCreate {
	_c.mutation.SetCi(v)
	return _c
}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.Ci(); !ok {
		return &ValidationError{Name: "ci", err: errors.New(`ent: missing required field "User.ci"`)}
	}
